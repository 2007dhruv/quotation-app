...
@section('styles')
    <style>
        ...
        .header-info .quotation-number {
            font-size: 14px;
            color: #6b7280;
        }

        .header-info .date-info {
            text-align: right;
        }

        .header-info .date-info p {
            font-size: 14px;
            color: #6b7280;
            margin: 4px 0;
        }
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="actions">
                ...
                <a href="{{ route('quotations.edit', $quotation) }}" class="btn btn-warning"
                    style="color: #fff; background-color: #f59e0b; border-color: #f59e0b;">Edit</a>
                ...
                <a href="{{ route('quotations.pdf2.stream', $quotation) }}" class="btn btn-primary" target="_blank">View
                    pdf</a>
        ...
        <div class="card-body">
            ...
            <div class="header-info">
                <div>
                    <h2>QUOTATION <span
                            class="status status-{{ $quotation->status }}">{{ ucfirst($quotation->status) }}</span></h2>
            ...
            <div class="customer-info">
                ...
                @if($quotation->customer->city || $quotation->customer->state)
                    <p>{{ $quotation->customer->city }}{{ $quotation->customer->city && $quotation->customer->state ? ', ' : '' }}{{ $quotation->customer->state }}
                    </p>
                @endif
            ...
            <!-- Totals -->
            <div class="totals-section" style="display: flex; justify-content: flex-end; width: 100%;">
                <div class="totals-box" style="width: 100%; max-width: 400px;">
